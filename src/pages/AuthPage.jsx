...
export default function AuthPage() {
    ...
    const url = "https://9ea827d5-e251-4c16-8826-dbd589f8691f-00-1dmxmuvq5vvi6.sisko.replit.dev";
    ...
    return (
        <Row>
            ...
            <Col sm={6}>
                ...
                <p className="my-5" style={{ fontSize: 32 }}>Join Twitter Today</p>
                ...
                <Col sm={5} className="d-grid gap-2">
                    ...
                    <Button className="rounded-pill" onClick={handleShowSignUp}>Create account</Button>
                    <p style={{ fontSize: 12 }}>
